...
namespace WooCommerce.NET.Tests
{
	...
	public class DeserializationTests
	{
		...
		[TestCase(@"ProductsJsonResponse_WhenDatesAreIncorrect.json", "0001-01-01T00:00:00", TestName = "DeserializeJSon_ProductsHaveDateTimeMinValue_WhenDatesAreIncorrect")]
		[TestCase(@"ProductsJsonResponse_WhenDatesAreCorrect.json", "2023-11-29T19:03:58", TestName = "DeserializeJSon_ProductsHaveCorrectDateTimeValues_WhenDatesAreCorrect")]
		[TestCase(@"ProductsJsonResponse_WhenDatesAreNull.json", "0001-01-01T00:00:00", TestName = "DeserializeJSon_ProductsHaveDateTimeMinValue_WhenDatesAreNull")]
		[TestCase(@"ProductsJsonResponse_WhenDatesAreEmpty.json", "0001-01-01T00:00:00", TestName = "DeserializeJSon_ProductsHaveDateTimeMinValue_WhenDatesAreEmpty")]
		public void DateTimeDeserializeJson(string fileName, string expectedDateValue)
		{
			// arrange
			var finalPath = Path.Combine(_baseFilesPath, fileName);
			var jsonResponse = File.ReadAllText(finalPath);
		...
		[TestCase(@"ProductsJsonResponse_WhenManageStockValueIsParent.json", false, TestName = "DeserializeJSon_ManageStockIsFalse_WhenManageStockValueIsParent")]
		[TestCase(@"ProductsJsonResponse_WhenManageStockValueIsTrue.json", true, TestName = "DeserializeJSon_ManageStockIsFalse_WhenManageStockValueIsTrue")]
		[TestCase(@"ProductsJsonResponse_WhenManageStockValueIsNull.json", false, TestName = "DeserializeJSon_ManageStockIsFalse_WhenManageStockValueIsNull")]
		[TestCase(@"ProductsJsonResponse_WhenManageStockValueIsFalse.json", false, TestName = "DeserializeJSon_ManageStockIsFalse_WhenManageStockValueIsFalse")]
